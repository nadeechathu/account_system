...
@section('title')
Member View | Smart Life Investment
@endsection
@section('content')
                        ...
                        <div class="card">
                           <div class="card-body py-1">
                              ...
                              <div class="row justify-content-end">
                                <div class="col-12 py-2 text-center d-block d-sm-none">
                                    <a  href="{{ route('mobile.allMembers') }}" class="text-center border-2 btn btn-info waves-effect waves-float waves-info w-100">Back</a>
                                </div>

                                 <div class="col-lg-9 col-12">
                                    <h2 class=" d-none-mobile"> View Member - {{ $member->member_name }} </h2>
                                    <h5 class="d-block d-sm-none fw-bolder"> View Member - {{ $member->member_name }} </h5>
                                 </div>
                                 <div class="col-3 d-none-mobile">
                                    <a href="{{ route('member.createUI') }}" class="btn btn-primary w-100">
                                    Add Member
                                    </a>
                                 </div>
                              </div>
                                 ...
                                 <div class="row">
                                    <div class="col-lg-6">
                                       <div class="form-group">
                                          ...
                                          <select class="form-control" id="center_id" name="center_id" disabled>
                                    ...
                                    <div class="col-lg-6">
                                       <div class="form-group">
                                          ...
                                          <select name="loan_category_id" class="form-control" id="loan_category_id" disabled>
                                             ...
                                             <div class="row">
                                                 ...
                                                 <div class="col-lg-6">
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      Phone 1</label>
                                                      <input type="text"  class="form-control" readonly
                                                      value="{{ $guarantor->guarantor_01_phone }}">
                                                   </div>
                                                   <div class="form-group">
                                                 ...
                                                 <div class="col-lg-6">
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      Phone 2</label>
                                                      <input type="text"  class="form-control" readonly
                                                      value="{{ $guarantor->guarantor_02_phone }}">
                                                   </div>
                                                   <div class="form-group">
                                       ...
                                       <div class="card1">
                                          <div class="row">
                                             ...
                                             <div class="form-group">
                                                ...
                                                Phone</label>
                                                <input type="text"  class="form-control" readonly
                                                   value="{{ $guarantor->member_relationship_pserson_phone }}">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
